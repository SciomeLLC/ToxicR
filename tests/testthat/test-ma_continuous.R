...
test_that("Laplace", {
  ...
  validate_model(AA$`Indiv_exp-5_normal-ncv`, "Model: Exponential-5 Distribution: Normal-NCV", c(10.3054183950297, 0.0316962480160407, 0.683696153196204, 1.93794411345487, 0.268202136937105, -2.15510619282155), c(BMD = 6.521937251091, BMDL = 5.677321330143, BMDU = 6.656941352189))
